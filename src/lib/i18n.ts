...
export const copy = {
  'zh-CN': {
    ...
    navHome: '首页',
    searchTitle: '搜索',
    searchDesc: '搜索已发布的文章与研究笔记。',
    searchLabel: '搜索文章与研究笔记',
    ...
    tagsTitle: '标签',
    tagsDesc: '按标签浏览文章与研究笔记。',
    tagsAll: '全部',
    tagsEmpty: '没有匹配的标签。',
    tagsNoDocs: '没有匹配的文档。',
    tagPageDesc: '带有此标签的文章与研究笔记。',
    backToTags: '← 全部标签',
    projectsTitle: '项目',
    projectsH1: '项目是一条线',
  ...
  en: {
    ...
    navHome: 'Home',
    searchTitle: 'Search',
    searchDesc: 'Search published essays and research notes.',
    searchLabel: 'Search essays and research notes',
    ...
    tagsTitle: 'Tags',
    tagsDesc: 'Browse essays and research notes by tag.',
    tagsAll: 'All',
    tagsEmpty: 'No matching tags.',
    tagsNoDocs: 'No matching documents.',
    tagPageDesc: 'Essays and research notes with this tag.',
    backToTags: '← All tags',
